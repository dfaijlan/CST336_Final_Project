        ...
        <div class="container">
            ...
            <form method="get">
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="kingdom-name" id="kingdom-name" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="coins-collected" class="col-sm-3 col-form-label">Purple Coins Collected:</label>
                    <div class="col-sm-6">
                        <input type="number" class="form-control" name="coins-collected" id="coins-collected" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="coins-total" class="col-sm-3 col-form-label">Total Purple Coins:</label>
                    <div class="col-sm-6">
                        <input type="number" class="form-control" name="coins-total" id="coins-total" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="moons-collected" class="col-sm-3 col-form-label">Power Moons Collected:</label>
                    <div class="col-sm-6">
                        <input type="number" class="form-control" name="moons-collected" id="moons-collected" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="moons-total" class="col-sm-3 col-form-label">Total Power Moons:</label>
                    <div class="col-sm-6">
                        <input type="number" class="form-control" name="moons-total" id="moons-total" required>
                    </div>
                </div>
                <input class="btn btn-dark" type="submit" name="addWorld" value="Enter">
            </form>
        </div>
        <?=addWorld()?>
    </body>
